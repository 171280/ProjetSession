...
dfClientsPerdusNet.groupby(['Attrition_Flag'], as_index=False).agg(total=('Attrition_Flag', 'count')).groupby(['Attrition_Flag']).sum().plot(kind='pie', subplots=True, shadow = True,startangle=90,
figsize=(5,5), autopct='%1.1f%%')

print("On constate que 16.1% des clients se désabonnent de leur carte de credit")

dfClientsPerdusNet.groupby(['Gender'], as_index=False).agg(total=('Gender', 'count')).groupby(['Gender']).sum().plot(kind='pie', subplots=True, shadow = True,startangle=90,
figsize=(5,5), autopct='%1.1f%%')
...
dfClientsPerdusNet.groupby(['Education_Level', 'Attrition_Flag'], as_index=False).agg(total=('Education_Level', 'count')).groupby(['Education_Level', 'Attrition_Flag']).sum().plot(kind='pie', subplots=True, shadow = True,startangle=90,
...
ax=sns.countplot('Education_Level', hue='Attrition_Flag', 
                 data=dfClientsPerdusNet)
with_hue(ax, dfClientsPerdusNet.Education_Level, 2, 7)

plt.figure(figsize=(15,5))
ax=sns.countplot('Education_Level',  
                 data=dfClientsPerdusNet)
...
plt.figure(figsize=(15,10))
plt.subplot(2,1,1)
ax=sns.countplot('Marital_Status',  
                 data=dfClientsPerdusNet)
without_hue(ax, dfClientsPerdusNet.Marital_Status)
plt.subplot(2,1,2)
ax=sns.countplot('Marital_Status', hue='Attrition_Flag', 
                 data=dfClientsPerdusNet)
without_hue(ax, dfClientsPerdusNet.Marital_Status)
plt.show()
...
plt.figure(figsize=(15,10))
plt.subplot(2,1,1)
ax=sns.countplot('Income_Category',  
                 data=dfClientsPerdusNet)
without_hue(ax, dfClientsPerdusNet.Income_Category)
plt.subplot(2,1,2)
ax=sns.countplot('Income_Category', hue='Attrition_Flag', 
                 data=dfClientsPerdusNet)
without_hue(ax, dfClientsPerdusNet.Income_Category)
plt.show()
...
plt.figure(figsize=(15,10))
plt.subplot(2,1,1)
ax=sns.countplot('Card_Category',  
                 data=dfClientsPerdusNet)
without_hue(ax, dfClientsPerdusNet.Card_Category)
plt.subplot(2,1,2)
ax=sns.countplot('Card_Category', hue='Attrition_Flag', 
                 data=dfClientsPerdusNet)
without_hue(ax, dfClientsPerdusNet.Card_Category)
plt.show()
...
plt.figure(figsize=(15,10))
plt.subplot(2,1,1)
ax=sns.countplot('Gender',  
                 data=dfClientsPerdusNet)
without_hue(ax, dfClientsPerdusNet.Gender)
plt.subplot(2,1,2)
ax=sns.countplot('Gender', hue='Attrition_Flag', 
                 data=dfClientsPerdusNet)
without_hue(ax, dfClientsPerdusNet.Gender)
plt.show()
...
plt.figure(figsize=(15,10))
plt.subplot(2,1,1)
ax=sns.countplot('Attrition_Flag',  
                 data=dfClientsPerdusNet)
without_hue(ax, dfClientsPerdusNet.Attrition_Flag)
plt.subplot(2,1,2)
ax=sns.countplot('Attrition_Flag', hue='Attrition_Flag', 
                 data=dfClientsPerdusNet)
without_hue(ax, dfClientsPerdusNet.Attrition_Flag)
plt.show()
